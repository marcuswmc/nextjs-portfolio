  ...
  return (
    <div ref={contextRef}>
      <div style={{ clipPath: "polygon(0 0, 100% 0%, 100% 100%, 0% 100%)" }}>
        ...
        >
          <p
            className={`text-[12px] font-light tracking-[0.5rem] uppercase px-8 md:px-10 ${textColor}`}
          >
            {subtitle}
          </p>
          <div className="px-8 md:px-10 lg:px-10">
            <h2
      ...
      <div className={`relative px-8 md:px-10 lg:px-10 ${textColor}`}>
